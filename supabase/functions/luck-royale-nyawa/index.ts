...
const PREMIUM_PRIZES: Prize[] = [
  ...
  { kind: "gems",          value: 75,    label: "💎 +75 Gem PREMIUM",         emoji: "💎", rarity: "rare",      weight: 18,    color: "#8b5cf6" },
  { kind: "gems",          value: 120,   label: "💎 +120 Gem PREMIUM",        emoji: "💎", rarity: "rare",      weight: 14,    color: "#8b5cf6" },
  { kind: "gems",          value: 160,   label: "💎 +160 Gem PREMIUM",        emoji: "💎", rarity: "rare",      weight: 10,    color: "#8b5cf6" },
  { kind: "lucky_token" as any, value: 1, label: "🎟️ +1 Lucky Token PREMIUM", emoji: "🎟️", rarity: "rare",      weight: 12,    color: "#22d3ee" },
  // === EPIC (banyak) ===
  ...
  { kind: "gems",          value: 200,   label: "💎 +200 Gem EPIC",           emoji: "💎", rarity: "epic",      weight: 14,    color: "#8b5cf6" },
  { kind: "gems",          value: 350,   label: "💎 +350 Gem EPIC",           emoji: "💎", rarity: "epic",      weight: 10,    color: "#8b5cf6" },
  { kind: "gems",          value: 500,   label: "💎 +500 Gem EPIC+",          emoji: "💎", rarity: "epic",      weight: 7,     color: "#8b5cf6" },
  ...
  { kind: "lucky_token" as any, value: 2, label: "🎟️ +2 Lucky Token EPIC",    emoji: "🎟️", rarity: "epic",      weight: 7,     color: "#a855f7" },
  ...
  { kind: "gems",          value: 600,   label: "💎 +600 Gem LEGEND",         emoji: "💎", rarity: "legendary", weight: 7,     color: "#facc15" },
  { kind: "gems",          value: 900,   label: "💎 +900 Gem LEGEND",         emoji: "💎", rarity: "legendary", weight: 5,     color: "#facc15" },
  ...
  { kind: "gems",          value: 1500,  label: "💎 +1.500 Gem LEGEND+",      emoji: "💎", rarity: "legendary", weight: 3,     color: "#facc15" },
  { kind: "gems",          value: 2200,  label: "💎 +2.200 Gem LEGEND+",      emoji: "💎", rarity: "legendary", weight: 2,     color: "#facc15" },
  { kind: "lucky_token" as any, value: 3, label: "🎟️ +3 Lucky Token LEGEND",  emoji: "🎟️", rarity: "legendary", weight: 2,     color: "#fbbf24" },
  ...
  { kind: "gems",          value: 3000,  label: "💎 +3.000 Gem MYTHIC",       emoji: "💎", rarity: "mythic",    weight: 2,     color: "#fde68a" },
  { kind: "gems",          value: 5000,  label: "💎 +5.000 Gem MYTHIC",       emoji: "💎", rarity: "mythic",    weight: 1.2,   color: "#fde68a" },
  ...
  { kind: "gems",          value: 10000, label: "💎 +10.000 Gem MYTHIC",      emoji: "💎", rarity: "mythic",    weight: 0.7,   color: "#fde68a" },
  { kind: "gems",          value: 20000, label: "💎 +20.000 Gem GOD",         emoji: "💎", rarity: "mythic",    weight: 0.3,   color: "#fde68a" },
  ...
  { kind: "gems",          value: 50000, label: "👑 +50.000 GEM JACKPOT",     emoji: "💎", rarity: "mythic",    weight: 0.08,  color: "#fef08a" },
  { kind: "lucky_token" as any, value: 5, label: "👑 +5 Lucky Token MYTHIC",  emoji: "🎟️", rarity: "mythic",    weight: 0.4,   color: "#f0abfc" },
];
