    ...
    if (action === "tier_status" || action === "tier_spin") {
      const TIERS: Record<string, { key: string; name: string; cost: number; limit: number; desc: string; ticketType: "normal" | "premium"; ticketCost: number; pool: Prize[] }> = {
        S: {
          ...
          desc: "Tanpa limit · super murah 10 gem / 1 tiket normal.",
          ticketType: "normal", ticketCost: 1,
          pool: [
            { kind: "streak_coins", value: 5,   label: "🪙 +5 Koin Streak",   emoji: "🪙", rarity: "common", weight: 30, color: "#facc15" },
            { kind: "streak_coins", value: 15,  label: "🪙 +15 Koin Streak",  emoji: "🪙", rarity: "common", weight: 22, color: "#fbbf24" },
            { kind: "streak_coins", value: 30,  label: "🪙 +30 Koin Streak",  emoji: "🪙", rarity: "common", weight: 14, color: "#fde047" },
            { kind: "gems",         value: 5,   label: "💎 +5 Gem",           emoji: "💎", rarity: "common", weight: 18, color: "#22d3ee" },
            { kind: "gems",         value: 15,  label: "💎 +15 Gem",          emoji: "💎", rarity: "rare",   weight: 12, color: "#38bdf8" },
            { kind: "gems",         value: 25,  label: "💎 +25 Gem",          emoji: "💎", rarity: "rare",   weight: 8,  color: "#0ea5e9" },
            { kind: "auto_hint",    value: 1,   label: "💡 +1 Hint",          emoji: "💡", rarity: "rare",   weight: 6,  color: "#a3e635" },
            { kind: "extra_life",   value: 1,   label: "❤️ +1 Nyawa",         emoji: "❤️", rarity: "rare",   weight: 6,  color: "#f472b6" },
            { kind: "time_freeze",  value: 1,   label: "⏳ +1 Time Freeze",   emoji: "⏳", rarity: "rare",   weight: 4,  color: "#67e8f9" },
            { kind: "spin_ticket_normal" as any, value: 1, label: "🎫 +1 Tiket Normal", emoji: "🎫", rarity: "rare", weight: 5, color: "#22d3ee" },
            { kind: "spin_ticket_normal" as any, value: 3, label: "🎫 +3 Tiket Normal", emoji: "🎫", rarity: "epic", weight: 1.5, color: "#06b6d4" },
            { kind: "game_credits", value: 1,   label: "🔑 +1 Kredit Game",   emoji: "🔑", rarity: "epic",   weight: 2.5, color: "#60a5fa" },
            { kind: "gems",         value: 60,  label: "💎 +60 Gem",          emoji: "💎", rarity: "epic",   weight: 2,  color: "#a855f7" },
            { kind: "spin_ticket_normal" as any, value: 8, label: "🎫 +8 Tiket Normal", emoji: "🎫", rarity: "legendary", weight: 0.8, color: "#fbbf24" },
            { kind: "spin_ticket_premium" as any, value: 1, label: "🎟️ +1 Tiket Premium", emoji: "🎟️", rarity: "legendary", weight: 0.7, color: "#e879f9" },
            { kind: "game_balance", value: 500, label: "💵 +Rp 500 Saldo IN", emoji: "💵", rarity: "epic", weight: 1.5, color: "#34d399" },
            { kind: "gems",         value: 150, label: "💎 +150 Gem",         emoji: "💎", rarity: "legendary", weight: 0.6, color: "#f59e0b" },
            { kind: "gems",         value: 500, label: "👑 JACKPOT +500 Gem", emoji: "👑", rarity: "mythic", weight: 0.2, color: "#f43f5e" },
          ],
        },
        A: {
          key: "A", name: "TIER A · ROOKIE", cost: 40, limit: 0,
          desc: "Tanpa limit · 40 gem / 2 tiket normal, hadiah kecil tapi sering.",
          ticketType: "normal", ticketCost: 2,
          pool: [
            { kind: "streak_coins", value: 10,  label: "🪙 +10 Koin Streak",  emoji: "🪙", rarity: "common", weight: 26, color: "#facc15" },
            { kind: "streak_coins", value: 25,  label: "🪙 +25 Koin Streak",  emoji: "🪙", rarity: "common", weight: 18, color: "#fbbf24" },
            { kind: "streak_coins", value: 60,  label: "🪙 +60 Koin Streak",  emoji: "🪙", rarity: "common", weight: 12, color: "#fde047" },
            { kind: "gems",         value: 10,  label: "💎 +10 Gem",          emoji: "💎", rarity: "common", weight: 16, color: "#22d3ee" },
            { kind: "gems",         value: 30,  label: "💎 +30 Gem",          emoji: "💎", rarity: "rare",   weight: 10, color: "#38bdf8" },
            { kind: "gems",         value: 55,  label: "💎 +55 Gem",          emoji: "💎", rarity: "rare",   weight: 7,  color: "#0ea5e9" },
            { kind: "auto_hint",    value: 2,   label: "💡 +2 Hint",          emoji: "💡", rarity: "rare",   weight: 8,  color: "#a3e635" },
            { kind: "extra_life",   value: 2,   label: "❤️ +2 Nyawa",         emoji: "❤️", rarity: "rare",   weight: 7,  color: "#f472b6" },
            { kind: "time_freeze",  value: 2,   label: "⏳ +2 Time Freeze",   emoji: "⏳", rarity: "rare",   weight: 5,  color: "#67e8f9" },
            { kind: "streak_freeze",value: 1,   label: "🧊 +1 Streak Freeze", emoji: "🧊", rarity: "epic",   weight: 4,  color: "#7dd3fc" },
            { kind: "spin_ticket_normal" as any, value: 2, label: "🎫 +2 Tiket Normal", emoji: "🎫", rarity: "epic", weight: 4, color: "#06b6d4" },
            { kind: "spin_ticket_normal" as any, value: 5, label: "🎫 +5 Tiket Normal", emoji: "🎫", rarity: "legendary", weight: 1.2, color: "#fbbf24" },
            { kind: "game_credits", value: 2,   label: "🔑 +2 Kredit Game",   emoji: "🔑", rarity: "epic",   weight: 4, color: "#60a5fa" },
            ...
            { kind: "game_balance", value: 1500,label: "💵 +Rp 1.500 Saldo IN",emoji: "💵", rarity: "legendary", weight: 1.5, color: "#10b981" },
            { kind: "gems",         value: 400, label: "💎 +400 Gem",         emoji: "💎", rarity: "legendary", weight: 1, color: "#f59e0b" },
            { kind: "spin_ticket_normal" as any, value: 10, label: "🎫 +10 Tiket Normal", emoji: "🎫", rarity: "legendary", weight: 0.9, color: "#22d3ee" },
            { kind: "spin_ticket_premium" as any, value: 1, label: "🎟️ +1 Tiket Premium", emoji: "🎟️", rarity: "legendary", weight: 1.5, color: "#e879f9" },
            { kind: "spin_ticket_premium" as any, value: 3, label: "🎟️ +3 Tiket Premium", emoji: "🎟️", rarity: "mythic", weight: 0.5, color: "#f0abfc" },
            { kind: "game_balance", value: 5000, label: "💵 +Rp 5.000 Saldo IN", emoji: "💵", rarity: "mythic", weight: 0.5, color: "#fb923c" },
            { kind: "gems",         value: 1000,label: "👑 JACKPOT +1.000 Gem",emoji: "👑", rarity: "mythic", weight: 0.4, color: "#f43f5e" },
          ],
        },
        B: {
          key: "B", name: "TIER B · ELITE", cost: 150, limit: 0,
          desc: "Tanpa limit · 150 gem / 1 tiket premium, peluang epic besar.",
          ticketType: "premium", ticketCost: 1,
          pool: [
            { kind: "gems",         value: 60,   label: "💎 +60 Gem",           emoji: "💎", rarity: "common", weight: 20, color: "#22d3ee" },
            { kind: "streak_coins", value: 100,  label: "🪙 +100 Koin Streak",  emoji: "🪙", rarity: "common", weight: 15, color: "#facc15" },
            { kind: "gems",         value: 150,  label: "💎 +150 Gem",          emoji: "💎", rarity: "rare",   weight: 14, color: "#38bdf8" },
            { kind: "streak_coins", value: 250,  label: "🪙 +250 Koin Streak",  emoji: "🪙", rarity: "rare",   weight: 10, color: "#fbbf24" },
            { kind: "streak_coins", value: 500,  label: "🪙 +500 Koin Streak",  emoji: "🪙", rarity: "rare",   weight: 7,  color: "#fde047" },
            { kind: "game_credits", value: 2,    label: "🔑 +2 Kredit Game",    emoji: "🔑", rarity: "rare",   weight: 9,  color: "#60a5fa" },
            { kind: "time_freeze",  value: 2,    label: "⏳ +2 Time Freeze",    emoji: "⏳", rarity: "rare",   weight: 8,  color: "#67e8f9" },
            { kind: "auto_hint",    value: 3,    label: "💡 +3 Hint",           emoji: "💡", rarity: "rare",   weight: 7,  color: "#a3e635" },
            { kind: "extra_life",   value: 3,    label: "❤️ +3 Nyawa",          emoji: "❤️", rarity: "rare",   weight: 6,  color: "#f472b6" },
            { kind: "streak_freeze",value: 1,    label: "🧊 +1 Streak Freeze",  emoji: "🧊", rarity: "epic",   weight: 5,  color: "#7dd3fc" },
            { kind: "streak_freeze",value: 3,    label: "🧊 +3 Streak Freeze",  emoji: "🧊", rarity: "epic",   weight: 3,  color: "#38bdf8" },
            { kind: "spin_ticket_normal" as any,  value: 5, label: "🎫 +5 Tiket Normal",  emoji: "🎫", rarity: "epic", weight: 5, color: "#06b6d4" },
            { kind: "spin_ticket_premium" as any, value: 1, label: "🎟️ +1 Tiket Premium", emoji: "🎟️", rarity: "epic", weight: 4, color: "#e879f9" },
            { kind: "spin_ticket_premium" as any, value: 3, label: "🎟️ +3 Tiket Premium", emoji: "🎟️", rarity: "legendary", weight: 1.2, color: "#f0abfc" },
            { kind: "gems",         value: 400,  label: "💎 +400 Gem",          emoji: "💎", rarity: "epic",   weight: 7,  color: "#a855f7" },
            { kind: "game_balance", value: 2000, label: "💵 +Rp 2.000 Saldo IN",emoji: "💵", rarity: "epic",   weight: 5,  color: "#10b981" },
            { kind: "game_balance", value: 5000, label: "💵 +Rp 5.000 Saldo IN",emoji: "💵", rarity: "legendary", weight: 3, color: "#34d399" },
            { kind: "game_credits", value: 8,    label: "🔑 +8 Kredit Game",    emoji: "🔑", rarity: "legendary", weight: 2.5, color: "#818cf8" },
            { kind: "gems",         value: 1000, label: "💎 +1.000 Gem",        emoji: "💎", rarity: "legendary", weight: 2, color: "#f59e0b" },
            { kind: "spin_ticket_premium" as any, value: 8, label: "🎟️ +8 Tiket Premium", emoji: "🎟️", rarity: "mythic", weight: 0.6, color: "#f0abfc" },
            { kind: "spin_ticket_normal" as any,  value: 25, label: "🎫 +25 Tiket Normal", emoji: "🎫", rarity: "mythic", weight: 0.7, color: "#22d3ee" },
            { kind: "game_balance", value: 10000, label: "💵 +Rp 10.000 Saldo IN", emoji: "💵", rarity: "mythic", weight: 1.2, color: "#fb923c" },
            { kind: "gems",         value: 3000, label: "👑 JACKPOT +3.000 Gem",emoji: "👑", rarity: "mythic", weight: 1, color: "#f43f5e" },
          ],
        },
        C: {
          key: "C", name: "TIER C · LEGEND", cost: 500, limit: 0,
          desc: "Tanpa limit · 500 gem / 3 tiket premium, hadiah besar & mythic.",
          ticketType: "premium", ticketCost: 3,
          pool: [
            { kind: "gems",         value: 300,   label: "💎 +300 Gem",           emoji: "💎", rarity: "rare",   weight: 20, color: "#38bdf8" },
            { kind: "streak_coins", value: 500,   label: "🪙 +500 Koin Streak",   emoji: "🪙", rarity: "rare",   weight: 13, color: "#facc15" },
            { kind: "streak_coins", value: 1200,  label: "🪙 +1.200 Koin Streak", emoji: "🪙", rarity: "epic",   weight: 9,  color: "#fbbf24" },
            { kind: "gems",         value: 800,   label: "💎 +800 Gem",           emoji: "💎", rarity: "epic",   weight: 13, color: "#a855f7" },
            { kind: "game_credits", value: 5,     label: "🔑 +5 Kredit Game",     emoji: "🔑", rarity: "epic",   weight: 10, color: "#60a5fa" },
            { kind: "streak_freeze",value: 3,     label: "🧊 +3 Streak Freeze",   emoji: "🧊", rarity: "epic",   weight: 8,  color: "#7dd3fc" },
            { kind: "time_freeze",  value: 5,     label: "⏳ +5 Time Freeze",     emoji: "⏳", rarity: "epic",   weight: 7,  color: "#67e8f9" },
            { kind: "extra_life",   value: 8,     label: "❤️ +8 Nyawa",           emoji: "❤️", rarity: "epic",   weight: 6,  color: "#f472b6" },
            { kind: "auto_hint",    value: 10,    label: "💡 +10 Hint",           emoji: "💡", rarity: "epic",   weight: 6,  color: "#a3e635" },
            { kind: "spin_ticket_premium" as any, value: 2, label: "🎟️ +2 Tiket Premium", emoji: "🎟️", rarity: "epic", weight: 6, color: "#e879f9" },
            { kind: "spin_ticket_premium" as any, value: 5, label: "🎟️ +5 Tiket Premium", emoji: "🎟️", rarity: "legendary", weight: 2.5, color: "#f0abfc" },
            { kind: "spin_ticket_normal" as any,  value: 15,label: "🎫 +15 Tiket Normal", emoji: "🎫", rarity: "legendary", weight: 2, color: "#22d3ee" },
            { kind: "game_balance", value: 5000,  label: "💵 +Rp 5.000 Saldo IN", emoji: "💵", rarity: "epic",   weight: 9,  color: "#10b981" },
            { kind: "gems",         value: 2500,  label: "💎 +2.500 Gem",         emoji: "💎", rarity: "legendary", weight: 7, color: "#f59e0b" },
            { kind: "game_credits", value: 12,    label: "🔑 +12 Kredit Game",    emoji: "🔑", rarity: "legendary", weight: 5, color: "#818cf8" },
            { kind: "game_balance", value: 15000, label: "💵 +Rp 15.000 Saldo IN",emoji: "💵", rarity: "legendary", weight: 4, color: "#fb923c" },
            { kind: "gems",         value: 5000,  label: "💎 +5.000 Gem",         emoji: "💎", rarity: "legendary", weight: 3, color: "#fbbf24" },
            { kind: "game_balance", value: 25000, label: "💵 +Rp 25.000 Saldo IN",emoji: "💵", rarity: "mythic", weight: 1.5, color: "#f97316" },
            { kind: "spin_ticket_premium" as any, value: 10, label: "🎟️ +10 Tiket Premium", emoji: "🎟️", rarity: "mythic", weight: 1.2, color: "#f0abfc" },
            { kind: "spin_ticket_normal" as any,  value: 50, label: "🎫 +50 Tiket Normal", emoji: "🎫", rarity: "mythic", weight: 1, color: "#22d3ee" },
            { kind: "game_credits", value: 25,    label: "🔑 +25 Kredit Game",    emoji: "🔑", rarity: "mythic", weight: 1.5, color: "#818cf8" },
            { kind: "gems",         value: 10000, label: "👑 JACKPOT +10.000 Gem",emoji: "👑", rarity: "mythic", weight: 1, color: "#f43f5e" },
          ],
        },
        D: {
          key: "D", name: "TIER D · SULTAN", cost: 1500, limit: 0,
          desc: "Tanpa limit · 1.500 gem / 10 tiket premium, hadiah paling gila.",
          ticketType: "premium", ticketCost: 10,
          pool: [
            { kind: "gems",         value: 1200,  label: "💎 +1.200 Gem",          emoji: "💎", rarity: "epic",   weight: 22, color: "#a855f7" },
            { kind: "streak_coins", value: 2000,  label: "🪙 +2.000 Koin Streak",  emoji: "🪙", rarity: "epic",   weight: 14, color: "#facc15" },
            { kind: "streak_coins", value: 5000,  label: "🪙 +5.000 Koin Streak",  emoji: "🪙", rarity: "legendary", weight: 8, color: "#fbbf24" },
            { kind: "game_credits", value: 15,    label: "🔑 +15 Kredit Game",     emoji: "🔑", rarity: "epic",   weight: 12, color: "#60a5fa" },
            { kind: "streak_freeze",value: 10,    label: "🧊 +10 Streak Freeze",   emoji: "🧊", rarity: "epic",   weight: 8,  color: "#7dd3fc" },
            { kind: "extra_life",   value: 25,    label: "❤️ +25 Nyawa",           emoji: "❤️", rarity: "epic",   weight: 7,  color: "#f472b6" },
            { kind: "auto_hint",    value: 25,    label: "💡 +25 Hint",            emoji: "💡", rarity: "epic",   weight: 7,  color: "#a3e635" },
            { kind: "spin_ticket_premium" as any, value: 5,  label: "🎟️ +5 Tiket Premium",  emoji: "🎟️", rarity: "legendary", weight: 7, color: "#e879f9" },
            { kind: "spin_ticket_premium" as any, value: 12, label: "🎟️ +12 Tiket Premium", emoji: "🎟️", rarity: "mythic", weight: 2.5, color: "#f0abfc" },
            { kind: "gems",         value: 3000,  label: "💎 +3.000 Gem",          emoji: "💎", rarity: "legendary", weight: 13, color: "#f59e0b" },
            { kind: "game_balance", value: 25000, label: "💵 +Rp 25.000 Saldo IN", emoji: "💵", rarity: "legendary", weight: 11, color: "#fb923c" },
            { kind: "gems",         value: 6000,  label: "💎 +6.000 Gem",          emoji: "💎", rarity: "legendary", weight: 9,  color: "#fbbf24" },
            { kind: "game_credits", value: 40,    label: "🔑 +40 Kredit Game",     emoji: "🔑", rarity: "legendary", weight: 5, color: "#818cf8" },
            { kind: "game_balance", value: 50000, label: "💵 +Rp 50.000 Saldo IN", emoji: "💵", rarity: "mythic", weight: 6,  color: "#f43f5e" },
            { kind: "gems",         value: 12000, label: "💎 +12.000 Gem",         emoji: "💎", rarity: "mythic", weight: 4,  color: "#fb7185" },
            { kind: "game_balance", value: 100000,label: "👑 MEGA +Rp 100.000 Saldo", emoji: "👑", rarity: "mythic", weight: 1.2, color: "#ef4444" },
            { kind: "spin_ticket_premium" as any, value: 25, label: "🎟️ +25 Tiket Premium", emoji: "🎟️", rarity: "mythic", weight: 1.5, color: "#f0abfc" },
            { kind: "spin_ticket_normal" as any,  value: 100, label: "🎫 +100 Tiket Normal", emoji: "🎫", rarity: "mythic", weight: 1.5, color: "#22d3ee" },
