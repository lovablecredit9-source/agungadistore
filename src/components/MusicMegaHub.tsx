                    ...
                    {quests.length === 0 ? <p className="text-center text-sm text-muted-foreground py-8">Memuat…</p> : (
                      quests.map(q => {
                        ...
                        const titles: Record<string, string> = {
                          ...
                          unique_songs: `Putar ${q.target_value} lagu berbeda (min 2 menit)`,
                          finish_songs: `Selesaikan ${q.target_value} lagu (min 2 menit)`,
                          replay_liked: `Dengar ${q.target_value} lagu like (min 2 menit)`,
