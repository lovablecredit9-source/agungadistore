...
const PRIZE_POOL: { emoji: string; label: string; rarity: string }[] = [
  ...
  { emoji: "💎", label: "JACKPOT! 500 Gems", rarity: "legendary" },
  { emoji: "💰", label: "MEGA! Saldo IN Rp 10.000", rarity: "legendary" },
  { emoji: "💎", label: "200 Gems", rarity: "epic" },
  { emoji: "🪙", label: "Saldo IN Rp 5.000", rarity: "epic" },
  { emoji: "💎", label: "100 Gems", rarity: "epic" },
  { emoji: "🎮", label: "5 Game Credits (MAX)", rarity: "epic" },
  { emoji: "🪙", label: "Saldo IN Rp 2.000", rarity: "rare" },
  { emoji: "💎", label: "50 Gems", rarity: "rare" },
  { emoji: "🔥", label: "20 Streak Coins", rarity: "rare" },
  { emoji: "🎮", label: "4 Game Credits", rarity: "rare" },
  { emoji: "💎", label: "20 Gems", rarity: "common" },
